...
const TEMPLATES: DemoConnectorTemplate[] = [
  {
...
export function getDemoConnectorTemplate(id: string): DemoConnectorTemplate {
...
function redactTemplate(template: DemoConnectorTemplate) {
  return {
    id: template.id,
    kind: template.kind,
    displayName: template.displayName,
